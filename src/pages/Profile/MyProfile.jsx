                ...
                <div className="max-w-sm">
                    <div>
                        <div className="form-control">
                            ...
                            <input type="text" defaultValue={user?.displayName} {...register("displayName", { required: true })} placeholder='Full Name' className="input input-bordered rounded-lg w-full" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input type="number" defaultValue={user?.phoneNumber} {...register("phoneNumber", { required: true })} placeholder="phone number" className="input input-bordered rounded-lg" />
                        </div>
