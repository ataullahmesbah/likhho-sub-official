    ...
    return (
        <div className='p-10'>
            <div className='w-3/3 m-auto'>
                <h1 className='text-4xl font-bold my-10'>Dochub Inbox</h1>
            ...
            <div className='grid lg:grid-cols-2 my-10 w-3/4 m-auto'>
                <div>
                    <p className='inline-flex text-2xl font-bold items-center gap-2'> <BsFillPenFill></BsFillPenFill> Sign request</p>
                    <p className='text-xl'>When someone sends you a sign request, it appears here in your inbox.</p>
                </div>
                <div>
                    <p className='inline-flex text-2xl  items-center gap-2'> <AiOutlineForm></AiOutlineForm>  Form fills</p>
