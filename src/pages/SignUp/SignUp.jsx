    ...
    return (
        <div className="hero min-h-screen bg-base-200 my-10 rounded-xl">
            <form onSubmit={handleSubmit(onSubmit)} className="hero-content flex-col lg:flex-row">
                <div className="text-center lg:text-left w-1/2" ref={container}>
                ...
                <div className="card w-full max-w-sm shadow-2xl bg-base-100">
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <FaEye onClick={togglePassword} className='relative bottom-7 left-64'></FaEye>
                        ...
                        <p className='mt-2'>Already have an account? <Link to='/signin' className='text-blue-600 font-semibold'>Login</Link></p>
                    </div>
                    <Social></Social>
                </div>
            </form>
